...
class ModelTrainer:
    """Handles the training and selection of ideal functions."""
    ...
    def find_best_ideal_functions(self, 
        ...
        """
        Find the best ideal function for each training dataset using least-square method.
        
        Args:
            training_functions (Dict[int, TrainingFunction]): Training datasets
            ideal_functions (Dict[int, IdealFunction]): Available ideal functions
            
        Returns:
            Dict[int, int]: Mapping of training dataset number to best ideal function number
        """
        try:
            best_matches = {}
            ...
            for train_num, train_func in training_functions.items():
                ...
                # Set max training deviation for the selected ideal function
    ...
    def _calculate_point_deviations(self, train_func: TrainingFunction, ideal_func: IdealFunction) -> List[float]:
        ...
        Args:
            train_func (TrainingFunction): Training function
            ideal_func (IdealFunction): Ideal function
            
        Returns:
            List[float]: List of absolute deviations for each point
        """
        deviations = []
    ...
    def assign_test_data(self, test_data, selected_ideal_functions: Dict[int, IdealFunction]) -> List[Dict]:
        """
        Assign test data points to ideal functions based on deviation criteria.
        ...
        Returns:
            List[Dict]: List of test data assignments
        """
        try:
            assignments = []
            ...
            for _, row in test_data.iterrows():
                ...
                # If no valid assignment found, record as unassigned
